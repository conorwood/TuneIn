      ...
      <>
        ...
        */}
        <div className="flex bg-white h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <GoogleButton className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm ' onClick={props.handleSignIn} />

  
          {/* <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="#" method="POST">
              <div>
                <p className='block text-sm font-medium mt-5 mb-5 text-gray-900'> - OR - </p>
...
//                 <h1 className='text-2xl mb-3'>Sign In Below: </h1>
//                 <GoogleButton className='mt-3' onClick={props.handleSignIn} />
//             </div>
//         </div>
//     );
// }
