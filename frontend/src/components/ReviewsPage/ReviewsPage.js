                        ...
                        <li className="m-10 flex bg-gray-800 w-4/5 p-3 relative rounded-lg" key={idx}>
                            ...
                            <div className="flex flex-col items-center mx-auto justify-center">
                                ...
                                <Link className="m-4 w-full" to={`/album/${review.albumId}`}>
                                    <button className="mx-auto w-full flex rounded-2xl bg-gray-100 text-neutral-800 p-4 text-center transition ease-in-out duration-300 hover:scale-110 hover:bg-blue-700" onClick={() => handleDeleteReview(review.albumId)} review-album-id={review.albumId}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3">
