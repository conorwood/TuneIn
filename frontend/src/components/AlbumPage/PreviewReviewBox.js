...
export function PreviewReviewBox({ review, rating, favTracks, onEditReview }) {
    return (
        <div className="flex w-5/6 bg-gray-400 rounded-xl p-3 m-5 justify-between mx-auto divide-x">
            <div className="flex flex-col w-2/5 ml-3">
                <div className='flex'>
                    <button onClick={onEditReview} className='self-start transition ease-in-out duration-300 transform hover:text-blue-600 hover:scale-110 mr-2'>
                ...
                <p className='break-words w-full h-36 self-start resize-none'>{review}</p>
            </div>
